...
2. excel basically create workbook examples : DA Workbook.xlsx
...
4. **rows** : rows are in DA Workbook.xlsx

rows(1,2,3,4,5) verticle data

5. **columns** : columns are in DA Workbook.xlsx
...
9. **Range** : A group of adjacent cells for examples : 
cell(A1:B5), cell(A2:B5)

# basic interface related in excel
**structures of basic interface**

![alt text](image-4.png)

  1. **ribbon** : The toolbar of excel located at top with tabs such as 
                  Home | insert | page layout | formulas | data | Reviews | View | Help

  2. **Name Box**: shows the active cell references examples : 
                   A1 | B1 | C1 | D1
